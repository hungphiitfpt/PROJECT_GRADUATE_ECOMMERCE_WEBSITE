...
public interface ReviewProductRepository  extends JpaRepository<ShopProductReviewsEntity, Long>{
	...
	@Query(value = "SELECT shop_product_reviews.rating,shop_product_reviews.updated_at,shop_product_reviews.product_id,shop_product_reviews.is_deleted,shop_product_reviews.customer_id,shop_product_reviews.created_at,shop_product_reviews.comment,shop_product_reviews.id,shop_customer.last_name FROM shop_product_reviews  LEFT JOIN shop_customer "
