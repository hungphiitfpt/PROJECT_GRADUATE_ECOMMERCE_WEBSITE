...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    private com.poly.edu.project.graduation.dao.UserRepository userRepository;
    ...
    private Collection < ? extends GrantedAuthority> mapRolesToAuthorities(Collection <RoleUserEntity> roles) {
